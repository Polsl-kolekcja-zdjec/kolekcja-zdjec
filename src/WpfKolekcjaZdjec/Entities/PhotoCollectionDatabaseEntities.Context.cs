...
namespace WpfKolekcjaZdjec.Entities
{
    public partial class PhotoCollectionDatabaseEntities : ObjectContext
    {
        ...
        public ObjectSet<Tags2Photos> Tags2PhotosSet
        {
            get { return _tags2PhotosSet  ?? (_tags2PhotosSet = CreateObjectSet<Tags2Photos>("Tags2PhotosSet")); }
        }
        private ObjectSet<Tags2Photos> _tags2PhotosSet;
    
        public ObjectSet<Photos2Locations> Photos2LocationsSet
        {
            get { return _photos2LocationsSet  ?? (_photos2LocationsSet = CreateObjectSet<Photos2Locations>("Photos2LocationsSet")); }
        }
        private ObjectSet<Photos2Locations> _photos2LocationsSet;
